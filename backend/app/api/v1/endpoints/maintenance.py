...
DEMO_MAINTENANCE = [
    {
        "id": "m-001",
        "work_order": "WO-2025-0142",
        "type": "preventive",
        "priority": "medium",
        "status": "completed",
        "description": "Quarterly vibration analysis and bearing inspection for P-101",
    ...
    {
        "id": "m-002",
        "work_order": "WO-2025-0156",
        "type": "corrective",
        "priority": "high",
        "status": "completed",
        "description": "Mechanical seal replacement on P-101 due to leak detected",
    ...
    {
        "id": "m-003",
        "work_order": "WO-2025-0178",
        "type": "preventive",
        "priority": "medium",
        "status": "scheduled",
        "description": "Annual tube bundle inspection for E-301",
    ...
    {
        "id": "m-004",
        "work_order": "WO-2025-0189",
        "type": "predictive",
        "priority": "high",
        "status": "overdue",
        "description": "Compressor C-201 valve plate inspection — vibration trending high",
    ...
    {
        "id": "m-005",
        "work_order": "WO-2025-0195",
        "type": "breakdown",
        "priority": "urgent",
        "status": "in_progress",
        "description": "Emergency repair — Boiler B-401 safety valve stuck open",
    ...
    {
        "id": "m-006",
        "work_order": "WO-2025-0201",
        "type": "preventive",
        "priority": "low",
        "status": "scheduled",
        "description": "Motor M-601 annual insulation resistance test",
        ...
        "critical_equipment": [
            {
                ...
                "recommendations": ["Schedule vibration check", "Monitor bearing temperature"],
            },
            {
                "equipment_id": "B-401",
                ...
                "health_score": 65.0,
                "risk_level": "high",
                "days_since_maintenance": 108,
                "predicted_failure_days": 90,
                "recommendations": ["Urgent safety valve inspection", "Review water treatment program"],
            },
            {
                "equipment_id": "C-201",
                ...
                "health_score": 71.2,
                "risk_level": "medium",
                "days_since_maintenance": 66,
                "predicted_failure_days": 120,
                "recommendations": ["Valve plate inspection overdue", "Check piston rod packing"],
            },
        ],
        "failure_predictions": [
            {
    ...
    return [
        {
            ...
            "risk_level": "medium",
            "recommendation": "Plan replacement at next turnaround",
        },
        {
            "equipment_id": "B-401",
            "equipment_name": "Water Tube Boiler B-401",
            "component": "Safety Valve SV-401A",
        ...
        {
            "equipment_id": "C-201",
            "equipment_name": "Reciprocating Compressor C-201",
            "component": "Suction Valve Plate",
        ...
        {
            "equipment_id": "E-301",
            "equipment_name": "Heat Exchanger E-301",
            "component": "Tube Bundle",
            "failure_probability": 0.28,
            "remaining_useful_life_days": 200,
            "risk_level": "low",
            "recommendation": "Monitor shell-side pressure drop trend",
        },
    ]
