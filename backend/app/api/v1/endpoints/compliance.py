...
DEMO_COMPLIANCE = [
    {
        "id": "c-001",
        "regulation_ref": "OSHA 29 CFR 1910.119(e)",
        "standard": "osha",
        "category": "Process Hazard Analysis",
        "status": "compliant",
        "score": 92.0,
        "findings": ["PHA review completed on schedule", "All action items closed"],
        "violations": [],
        "recommendations": ["Update PHA for recent process changes"],
    ...
    {
        "id": "c-002",
        "regulation_ref": "OSHA 29 CFR 1910.119(j)",
        "standard": "osha",
        "category": "Mechanical Integrity",
        "status": "partially",
        "score": 78.0,
        "findings": ["3 of 5 equipment inspections completed", "Piping inspection schedule behind"],
        "violations": ["Overdue inspection for high-pressure piping in Unit-1"],
        "recommendations": ["Accelerate piping inspection schedule", "Add contractor support for NDE testing"],
    ...
    {
        "id": "c-003",
        "regulation_ref": "ISO 45001:2018 Section 6.1",
        "standard": "iso_45001",
        "category": "Actions to Address Risks",
        "status": "compliant",
        "score": 88.0,
        "findings": ["Risk register updated quarterly", "Emergency drills conducted as planned"],
        "violations": [],
        "recommendations": ["Expand near-miss reporting program"],
        "audit_date": "2025-04-10",
        "next_audit_date": "2025-10-10",
        "created_at": "2025-04-10T00:00:00Z",
    },
    {
        "id": "c-004",
        "regulation_ref": "ISO 14001:2015 Section 8.1",
        "standard": "iso_14001",
        "category": "Operational Planning and Control",
        "status": "non_compliant",
        "score": 55.0,
        "findings": ["Environmental monitoring gaps identified", "Waste disposal records incomplete"],
        "violations": [
            "Missing air emission monitoring data for Q1 2025",
            "Hazardous waste storage exceeding 90-day limit",
        ],
        "recommendations": [
            "Install continuous emission monitors",
            "Implement digital waste tracking system",
            "Schedule immediate hazardous waste pickup",
        ],
    ...
    {
        "id": "c-005",
        "regulation_ref": "API 510 Section 7",
        "standard": "api",
        "category": "Pressure Vessel Inspection",
        "status": "compliant",
        "score": 95.0,
        "findings": ["All vessels inspected within schedule", "Corrosion rates within acceptable limits"],
        "violations": [],
        "recommendations": ["Consider upgrading V-501 relief valve"],
...
async def get_violations(
    ...
    return [
        {
            "id": "v-001",
            "regulation": "OSHA 29 CFR 1910.119(j)",
            "description": "Overdue inspection for high-pressure piping in Unit-1",
            "severity": "major",
            "status": "open",
            "days_open": 25,
        ...
        {
            "id": "v-002",
            "regulation": "ISO 14001:2015 Section 8.1",
            "description": "Missing air emission monitoring data for Q1 2025",
            "severity": "major",
            "status": "in_progress",
            "days_open": 14,
        ...
        },
        {
            "id": "v-003",
            "regulation": "ISO 14001:2015 Section 8.1",
            "description": "Hazardous waste storage exceeding 90-day limit",
            "severity": "critical",
            "status": "open",
            "days_open": 5,
